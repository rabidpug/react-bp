...
import {
  ...
  authRequestReducer,
  authSuccessReducer,
  changePasswordClearReducer,
  changePasswordCompleteReducer,
...
export const user = createReducer( userInitialState, {
  [AUTH_FAILURE]             : authFailureReducer,
  [AUTH_REQUEST]             : authRequestReducer,
  [AUTH_SUCCESS]             : authSuccessReducer,
  [CHANGE_PASSWORD_CLEAR]    : changePasswordClearReducer,
  [CHANGE_PASSWORD_COMPLETE] : changePasswordCompleteReducer,
  [CHANGE_PASSWORD_REQUEST]  : changePasswordRequestReducer,
